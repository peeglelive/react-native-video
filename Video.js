...
export default class Video extends Component {
  ...
  render() {
    ...
    Object.assign(nativeProps, {
      ...
      onVideoLoadStarts: this._onLoadStart,
      onVideoLoad: this._onLoad,
      onVideoErrors: this._onError,
      onVideoProgresss: this._onProgress,
...
Video.propTypes = {
  ...
  onVideoLoadStarts: PropTypes.func,
  onVideoLoad: PropTypes.func,
  onVideoBuffer: PropTypes.func,
  onVideoErrors: PropTypes.func,
  onVideoProgresss: PropTypes.func,
